...
var PlayerOverlay = /*#__PURE__*/function () {
  ...
  return _createClass(PlayerOverlay, [{
    ...
    value: function handleSocialShare(platform) {
      ...
      var text = encodeURIComponent("Watching ".concat(((_this$dramaData2 = this.dramaData) === null || _this$dramaData2 === void 0 ? void 0 : _this$dramaData2.title) || 'this Drama', " - Ep.").concat(((_this$currentEpisode4 = this.currentEpisode) === null || _this$currentEpisode4 === void 0 ? void 0 : _this$currentEpisode4.num) || 1, " on Global Shorts!"));
      var shareUrl = '';
      switch (platform) {
        case 'whatsapp':
        ...
        default:
          if (navigator.share) {
            ...
            navigator.share({
              ...
              return console.log('Share canceled', err);
            });
          }
          return;
      }
    ...
    value: function () {
      var _updateCheckinStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var checkinBtn, today, response, hasChecked, _t4;
    ...
    value: function () {
      var _handleCheckin = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var _this6 = this;
        var checkinBtn, redirectUrl, response, user, _t5;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 6:
              _context5.p = 6;
              _t5 = _context5.v;
              console.error('签到失败', _t5);
              this.showToast('网络错误，请重试');
            case 7:
              _context5.p = 7;
              setTimeout(function () {
                _this6.checkinCooldown = false;
              }, 1000);
    ...
    value: function () {
      var _loadFavoriteStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var dramaId, response, countSpan, btn, _t6;
    ...
    key: "loadLikeStatus",
    value: function () {
      var _loadLikeStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var _this7 = this;
        var response, countSpan, btn, _t7;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 4:
              _context7.p = 4;
              _t7 = _context7.v;
              console.error('loadLikeStatus error', _t7);
            case 5:
              return _context7.a(2);
          }
        }, _callee7, this, [[2, 4]]);
