...
var PaymentPage = /*#__PURE__*/function () {
  function PaymentPage(params) {
    ...
    this.selectedPaymentMethod = null; // 改为动态设置
    this.promoCode = null;
    this.discount = 0;
  ...
  return _createClass(PaymentPage, [{
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              this.initSwipeBack();
              _context.n = 1;
              return Promise.all([this.loadCoinPackages(), this.loadVipPlans(), this.loadPaymentGateways(),
              // ✅ 加载支付方式
              _core_auth_js__WEBPACK_IMPORTED_MODULE_2__["default"].isLoggedIn() ? this.loadTransactionHistory() : Promise.resolve()]);
            case 1:
              this.bindEvents();
              this.hideLoading();
    ...
    value: function () {
      var _loadPaymentGateways = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var token, res, data, stripeConfig, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              _context2.p = 0;
            ...
            case 3:
              ...
              // 检查 Stripe 是否可用
              stripeConfig = this.availableGateways.find(function (g) {
                return g.type === 'stripe';
              });
              if (!stripeConfig) {
                _context2.n = 4;
                break;
              ...
              // 需要额外获取 publishable key，所以再调一次管理接口
              _context2.n = 4;
              return this.loadStripePublishableKey();
            case 4:
            ...
            case 6:
              ...
              this.renderPaymentMethods(); // 显示默认
            case 7:
              return _context2.a(2);
          }
        }, _callee2, this, [[0, 6]]);
    ...
    }() // ✅ 获取 Stripe 的 Publishable Key
  }, {
    key: "loadStripePublishableKey",
    value: function () {
      var _loadStripePublishableKey = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var token, res, data, stripeConfig, _t2;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              ...
              token = _core_auth_js__WEBPACK_IMPORTED_MODULE_2__["default"].getToken();
              _context3.n = 1;
              return fetch('/api/admin/payment-gateways', {
                headers: {
                  'Authorization': "Bearer ".concat(token)
                }
              });
            ...
            case 2:
              data = _context3.v;
              if (data.success && Array.isArray(data.data)) {
                stripeConfig = data.data.find(function (g) {
                  return g.type === 'stripe' && g.is_active;
                });
                if (stripeConfig && stripeConfig.merchant_id) {
                  this.stripePublishableKey = stripeConfig.merchant_id;
                  this.stripeEnabled = true;
            ...
            case 3:
              _context3.p = 3;
              _t2 = _context3.v;
              console.error('获取 Stripe 配置失败:', _t2);
              this.stripeEnabled = false;
            case 4:
      ...
      function loadStripePublishableKey() {
        return _loadStripePublishableKey.apply(this, arguments);
      }
      return loadStripePublishableKey;
    }() // ✅ 渲染支付方式
  }, {
    ...
    value: function renderPaymentMethods() {
      ...
      container.innerHTML = gateways.map(function (gateway, index) {
        var style = styleMap[gateway.type] || styleMap['card'];
        var isActive = gateway.is_default || firstActive && index === 0;
        if (isActive) {
          _this3.selectedPaymentMethod = gateway.type;
          firstActive = false;
        }
        return "\n                <div class=\"method-card ".concat(style.bgClass, " ").concat(isActive ? 'active' : '', "\" data-method=\"").concat(gateway.type, "\">\n                    <div class=\"method-icon\">\n                        <i class=\"fas ").concat(style.icon, "\"></i>\n                    </div>\n                    <div class=\"method-name\">").concat(gateway.name || style.name, "</div>\n                    <div class=\"method-desc\">").concat(gateway.description || style.desc, "</div>\n                </div>\n            ");
      }).join('');
      this.bindPaymentMethodEvents();

      // ✅ 添加：初始化表单显示状态
      this.updatePaymentFormFields();
    ...
    value: function bindPaymentMethodEvents() {
      ...
      document.querySelectorAll('.method-card').forEach(function (card) {
        card.addEventListener('click', function () {
          ...
          // ✅ 添加：更新表单显示
          _this4.updatePaymentFormFields();
        });
      });
    }
    ...
    value: function updatePaymentFormFields() {
      ...
      if (method === 'stripe') {
        ...
        if (user !== null && user !== void 0 && user.email && emailInput) {
        ...
        this.hideFormGroup(emailField);
      } else {
        // 信用卡：显示全部
        cardFields.forEach(function (id) {
          return _this5.showFormGroup(id);
        });
        this.showFormGroup(emailField);
        var _emailInput = document.getElementById(emailField);
        if (_emailInput) _emailInput.readOnly = false;
      }
    }
    ...
    value: function () {
      var _loadCoinPackages = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var res, _t3;
    ...
    key: "loadVipPlans",
    value: function () {
      var _loadVipPlans = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var res, _t4;
    ...
    value: function () {
      var _loadTransactionHistory = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var user, res, _t5;
    ...
    value: function bindEvents() {
      ...
      (_document$getElementB4 = document.getElementById('promoCode')) === null || _document$getElementB4 === void 0 || _document$getElementB4.addEventListener('keypress', function (e) {
        if (e.key === 'Enter') _this6.applyPromoCode();
      });
    ...
    key: "applyPromoCode",
    value: function () {
      var _applyPromoCode = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
    ...
    key: "processPayment",
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var _document$getElementB5, _document$getElementB6, _document$getElementB7, _document$getElementB8, cardNumber, cardName, expiry, cvv, _document$getElementB9, email, payBtn, originalText, token, orderRes, orderData, _orderData$data, orderId, paymentParams, gateway, itemName, paymentSuccess, userRes, _t6;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 4:
              ...
              cardNumber = (_document$getElementB5 = document.getElementById('cardNumber')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.value.replace(/\s/g, '');
              cardName = (_document$getElementB6 = document.getElementById('cardName')) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.value;
              expiry = (_document$getElementB7 = document.getElementById('expiry')) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.value;
              cvv = (_document$getElementB8 = document.getElementById('cvv')) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.value;
              if (!(!cardNumber || !cardName || !expiry || !cvv)) {
                _context8.n = 5;
                break;
              }
              this.showError('请填写完整的卡信息');
              return _context8.a(2);
            case 5:
            ...
            case 6:
              ...
              this.showError('请输入有效的有效期 (MM/YY)');
              return _context8.a(2);
            case 7:
              if (!(cvv.length < 3)) {
                _context8.n = 8;
            ...
            case 8:
              ...
              email = (_document$getElementB9 = document.getElementById('email')) === null || _document$getElementB9 === void 0 ? void 0 : _document$getElementB9.value;
              if (email) {
                _context8.n = 9;
                break;
              }
              this.showError('请填写邮箱地址');
              return _context8.a(2);
            case 9:
              if (/^\S+@\S+\.\S+$/.test(email)) {
                _context8.n = 10;
            ...
            case 12:
              orderRes = _context8.v;
              _context8.n = 13;
              return orderRes.json();
            case 13:
              orderData = _context8.v;
            ...
            case 14:
              _orderData$data = orderData.data, orderId = _orderData$data.orderId, paymentParams = _orderData$data.paymentParams, gateway = _orderData$data.gateway, itemName = _orderData$data.itemName;
              if (!(gateway === 'stripe')) {
                _context8.n = 16;
                break;
              }
    ...
    value: function () {
      var _processStripePayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(orderId, paymentParams, itemName) {
        var _this7 = this;
        var publishableKey;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              publishableKey = this.stripePublishableKey || (paymentParams === null || paymentParams === void 0 ? void 0 : paymentParams.publishableKey);
              if (publishableKey) {
                _context9.n = 1;
                break;
              }
              ...
              return _context9.a(2, new Promise(function (resolve, reject) {
                if (!window.Stripe) {
                  ...
                  script.onload = function () {
                    return _this7.redirectToStripeCheckout(orderId, publishableKey, paymentParams, itemName, resolve, reject);
                  };
                  ...
                  _this7.redirectToStripeCheckout(orderId, publishableKey, paymentParams, itemName, resolve, reject);
                }
              }));
          }
        }, _callee9, this);
      }));
      function processStripePayment(_x, _x2, _x3) {
    ...
    value: function () {
      var _redirectToStripeCheckout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(orderId, publishableKey, paymentParams, itemName, resolve, reject) {
          ...
          while (1) switch (_context0.n) {
            case 0:
              ...
              return stripe.redirectToCheckout({
                lineItems: [{
                  price_data: {
                    currency: (paymentParams === null || paymentParams === void 0 ? void 0 : paymentParams.currency) || 'usd',
                    product_data: {
                      name: itemName
                    },
                    unit_amount: (paymentParams === null || paymentParams === void 0 ? void 0 : paymentParams.amount) || Math.round(this.selectedPackage.price * 100)
                  },
                  quantity: 1
                }],
                mode: 'payment',
            ...
            case 1:
              _yield$stripe$redirec = _context0.v;
      ...
      function redirectToStripeCheckout(_x4, _x5, _x6, _x7, _x8, _x9) {
    ...
    value: function () {
      var _processMockPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(orderId) {
      ...
      function processMockPayment(_x0) {
    ...
    key: "pollOrderStatus",
    value: function () {
      var _pollOrderStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(orderId) {
        var maxAttempts,
          interval,
          token,
          i,
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              maxAttempts = _args10.length > 1 && _args10[1] !== undefined ? _args10[1] : 30;
              interval = _args10.length > 2 && _args10[2] !== undefined ? _args10[2] : 2000;
              token = _core_auth_js__WEBPACK_IMPORTED_MODULE_2__["default"].getToken();
              i = 0;
            case 1:
              if (!(i < maxAttempts)) {
    ...
    value: function resetPaymentForm() {
      var _document$getElementB0,
        _this8 = this;
      (_document$getElementB0 = document.getElementById('paymentForm')) === null || _document$getElementB0 === void 0 || _document$getElementB0.reset();
      var payBtn = document.getElementById('payNowBtn');
      if (payBtn) {
      ...
      // ✅ 恢复表单显示
      setTimeout(function () {
        return _this8.updatePaymentFormFields();
      }, 50);
    }
  }, {
    key: "showLoading",
    value: function showLoading() {
      ...
      (_document$getElementB1 = document.getElementById('pageLoading')) === null || _document$getElementB1 === void 0 || _document$getElementB1.classList.add('show');
    }
  }, {
    key: "hideLoading",
    value: function hideLoading() {
      var _document$getElementB10;
      (_document$getElementB10 = document.getElementById('pageLoading')) === null || _document$getElementB10 === void 0 || _document$getElementB10.classList.remove('show');
    }
  }, {
    key: "showToast",
