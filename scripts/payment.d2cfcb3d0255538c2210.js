...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
window.auth = _core_auth_js__WEBPACK_IMPORTED_MODULE_3__["default"];
...
var PaymentPage = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentPage, [{
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              this.showLoading();
              this.initTabs();
              this.initSwipeBack(); // 初始化滑动返回

              // 使用导入的 auth，而不是 window.auth
              _context.n = 1;
              return Promise.all([this.loadCoinPackages(), this.loadVipPlans(), _core_auth_js__WEBPACK_IMPORTED_MODULE_3__["default"].isLoggedIn() ? this.loadTransactionHistory() : Promise.resolve()]);
            case 1:
              this.bindEvents();
              this.hideLoading();
    ...
    value: function updateCoinBalance() {
      ...
      var balanceSpan = document.querySelector('.coin-balance span');
      var balanceWrapper = document.querySelector('.coin-balance');
      if (balanceSpan) {
        var _user$coins;
        var balance = (user === null || user === void 0 || (_user$coins = user.coins) === null || _user$coins === void 0 ? void 0 : _user$coins.toLocaleString()) || '0';
        balanceSpan.textContent = balance;

        // 设置鼠标悬停时显示完整余额
        if (balanceWrapper) {
          balanceWrapper.setAttribute('title', "".concat(balance, " \u91D1\u5E01"));
        }
      }
    }
  }, {
    ...
    value: function () {
      var _loadCoinPackages = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var res, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              if (res.success && Array.isArray(res.data)) {
                this.coinPackages = res.data.map(function (pkg) {
                  return {
                    ...
                    discount: pkg.discount_percent || pkg.discount || 0,
                    popular: pkg.is_popular === 1 || pkg.popular || false,
                    is_best_value: pkg.is_best_value || false
                  };
                });
                console.log('金币套餐映射结果:', this.coinPackages);
              } else {
                this.coinPackages = [];
                console.warn('获取金币套餐失败或数据格式错误', res);
              }
              _context2.n = 3;
              break;
            case 2:
              _context2.p = 2;
              _t = _context2.v;
              console.error('加载金币套餐失败:', _t);
              this.showError('加载金币套餐失败');
              this.coinPackages = [];
            case 3:
    ...
    key: "loadVipPlans",
    value: function () {
      var _loadVipPlans = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var res, _t2;
        return _regenerator().w(function (_context3) {
              ...
              if (res.success && Array.isArray(res.data)) {
                this.vipPlans = res.data.map(function (plan) {
                  return {
                    ...
                    rawFeatures: plan.features ? Array.isArray(plan.features) ? plan.features : JSON.parse(plan.features) : []
                  };
                });
              }
              _context3.n = 3;
    ...
    value: function renderVipPlans() {
      ...
      container.innerHTML = this.vipPlans.map(function (plan) {
        ...
        var discount = plan.discount || 0;
        var popular = plan.popular || false;
        var featuresHtml = '';
        featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.noAds\"></span></li>";
        featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.exclusive\"></span></li>";
        featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.hdQuality\"></span></li>";
        if (plan.id === 'vip_quarterly' || plan.id === 'vip_yearly') {
          featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.extraCoins\"></span></li>";
        }
        if (plan.id === 'vip_yearly') {
          featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.badge\"></span></li>";
          featuresHtml += "<li><i class=\"fas fa-check\"></i> <span data-i18n=\"vip.feature.birthdayGift\"></span></li>";
        }
        var nameKey = plan.id === 'vip_monthly' ? 'vip.plan.monthly' : plan.id === 'vip_quarterly' ? 'vip.plan.quarterly' : 'vip.plan.yearly';
        return "\n                <div class=\"vip-card ".concat(popular ? 'popular' : '', "\" data-plan-id=\"").concat(plan.id, "\">\n                    ").concat(popular ? '<div class="popular-badge" data-i18n="payment.mostPopular">最受欢迎</div>' : '', "\n                    <div class=\"vip-icon\"><i class=\"fas fa-crown\"></i></div>\n                    <h3 class=\"vip-name\" data-i18n=\"").concat(nameKey, "\">").concat(plan.name, "</h3>\n                    <div class=\"vip-duration\">").concat(plan.duration, " <span data-i18n=\"payment.days\">\u5929</span></div>\n                    <div class=\"vip-price\">\n                        ").concat(originalPrice > price ? "<span class=\"original-price\">$".concat(originalPrice.toFixed(2), "</span>") : '', "\n                        <span class=\"current-price\">$").concat(price.toFixed(2), "</span>\n                    </div>\n                    ").concat(discount ? "<div class=\"vip-discount\" data-i18n=\"payment.save\" data-i18n-options='".concat(JSON.stringify({
          discount: discount
        }), "'>\u8282\u7701 ").concat(discount, "%</div>") : '', "\n                    <ul class=\"vip-features\">\n                        ").concat(featuresHtml, "\n                    </ul>\n                    <button class=\"buy-vip-btn\" data-plan='").concat(JSON.stringify(plan), "' data-i18n=\"payment.buyNow\">\u7ACB\u5373\u5F00\u901A</button>\n                </div>\n            ");
      }).join('');
      _core_i18n_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateDOM();
    }
  }, {
    ...
    value: function () {
      var _loadTransactionHistory = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var user, res, _t3;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
            ...
            case 3:
              ...
              if (res.success && Array.isArray(res.data)) {
                ...
                this.transactions = [];
                console.warn('获取交易记录失败或数据格式错误', res);
              }
              _context4.n = 5;
              break;
            case 4:
    ...
    value: function renderTransactionHistory() {
      ...
      container.innerHTML = this.transactions.map(function (t) {
        return "\n            <div class=\"history-item\">\n                <div class=\"history-info\">\n                    <div class=\"history-icon ".concat(t.status, "\">\n                        <i class=\"fas ").concat(_this3.getStatusIcon(t.status), "\"></i>\n                    </div>\n                    <div class=\"history-details\">\n                        <h4>").concat(t.description || t.item, "</h4>\n                        <p>").concat(new Date(t.createdAt).toLocaleString(), " \xB7 ").concat(t.paymentMethod || '', "</p>\n                    </div>\n                </div>\n                <div class=\"history-amount ").concat(t.status, "\">$").concat(t.amount.toFixed(2), "</div>\n            </div>\n        ");
      }).join('');
      _core_i18n_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateDOM();
    }
  }, {
    ...
    value: function bindEvents() {
      ...
      document.querySelectorAll('.method-card').forEach(function (card) {
        card.addEventListener('click', function () {
          ...
          _this4.selectedPaymentMethod = card.dataset.method;
        });
      });
      ...
      (_document$getElementB2 = document.getElementById('paymentForm')) === null || _document$getElementB2 === void 0 || _document$getElementB2.addEventListener('submit', function (e) {
        e.preventDefault();
        _this4.processPayment();
      });

      // 优惠码应用
      (_document$getElementB3 = document.getElementById('applyPromoBtn')) === null || _document$getElementB3 === void 0 || _document$getElementB3.addEventListener('click', function () {
        return _this4.applyPromoCode();
      });
      (_document$getElementB4 = document.getElementById('promoCode')) === null || _document$getElementB4 === void 0 || _document$getElementB4.addEventListener('keypress', function (e) {
        if (e.key === 'Enter') _this4.applyPromoCode();
      });
    }
  }, {
    key: "selectPackage",
    value: function selectPackage(pkg, type) {
      ...
      var finalPrice = this.applyDiscount(pkg.price);
    ...
    key: "applyDiscount",
    value: function applyDiscount(price) {
      return this.discount > 0 ? price * (1 - this.discount / 100) : price;
    }
  }, {
    key: "updatePayButton",
    ...
    key: "applyPromoCode",
    value: function () {
      var _applyPromoCode = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var input, code, mockValid, finalPrice;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
            ...
            case 1:
              ...
              if (mockValid[code]) {
                this.discount = mockValid[code];
                input.style.borderColor = 'var(--success)';
                this.showToast("\u4F18\u60E0\u7801\u5E94\u7528\u6210\u529F\uFF01\u83B7\u5F97".concat(this.discount, "%\u6298\u6263"));
                if (this.selectedPackage) {
                  finalPrice = this.applyDiscount(this.selectedPackage.price);
                  this.updatePayButton("\u652F\u4ED8 $".concat(finalPrice.toFixed(2)));
                }
              } else {
    ...
    key: "processPayment",
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var payBtn, originalText, token, orderRes, orderData, _orderData$data, orderId, amount, itemName, paymentParams, gateway, paymentSuccess, userRes, _t4;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 2:
              ...
              _context6.p = 3;
              token = _core_auth_js__WEBPACK_IMPORTED_MODULE_3__["default"].getToken(); // 1. 创建订单
              _context6.n = 4;
              return fetch('/api/payment/order', {
                ...
                body: JSON.stringify({
                  ...
                  successUrl: "".concat(window.location.origin, "/pages/payment-success.html"),
                  cancelUrl: "".concat(window.location.origin, "/pages/payment-cancel.html")
                })
              });
            case 4:
              orderRes = _context6.v;
              _context6.n = 5;
              return orderRes.json();
            case 5:
              orderData = _context6.v;
            ...
            case 6:
              _orderData$data = orderData.data, orderId = _orderData$data.orderId, amount = _orderData$data.amount, itemName = _orderData$data.itemName, paymentParams = _orderData$data.paymentParams, gateway = _orderData$data.gateway; // 2. 根据支付方式处理
              if (!(gateway === 'paypal')) {
                _context6.n = 8;
                break;
              }
              _context6.n = 7;
              return this.processPayPalPayment(orderId, amount, itemName);
            case 7:
              _context6.n = 11;
              break;
            case 8:
              ...
              _context6.n = 9;
              return this.processStripePayment(orderId, paymentParams, itemName);
            case 9:
              _context6.n = 11;
              break;
            case 10:
            ...
            case 13:
              userRes = _context6.v;
              if (userRes.success) {
                _core_auth_js__WEBPACK_IMPORTED_MODULE_3__["default"].setUser(userRes.data);
              }
              this.updateCoinBalance();
              this.showToast('支付成功！');
            ...
            case 17:
              _context6.p = 17;
              _t4 = _context6.v;
              console.error('支付失败:', _t4);
              this.showError(_t4.message || '支付失败，请重试');
            case 18:
              _context6.p = 18;
    ...
    value: function () {
      var _processPayPalPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(orderId, amount, itemName) {
        var _this5 = this;
              ...
              return _context7.a(2, new Promise(function (resolve, reject) {
                ...
                if (!window.paypal) {
                  ...
                  script.onload = function () {
                    return _this5.renderPayPalButtons(orderId, amount, itemName, resolve, reject);
                  };
                  script.onerror = function () {
                    return reject(new Error('PayPal SDK 加载失败'));
                  };
                  document.head.appendChild(script);
                } else {
                  _this5.renderPayPalButtons(orderId, amount, itemName, resolve, reject);
                }
              }));
          }
        }, _callee7);
      }));
      function processPayPalPayment(_x, _x2, _x3) {
        return _processPayPalPayment.apply(this, arguments);
      }
      return processPayPalPayment;
    }()
  }, {
    key: "renderPayPalButtons",
    value: function renderPayPalButtons(orderId, amount, itemName, resolve, reject) {
      // 创建临时容器
      var container = document.createElement('div');
      container.id = 'paypal-temp-container';
      ...
      window.paypal.Buttons({
        ...
        onApprove: function onApprove(data, actions) {
          return actions.order.capture().then(function (details) {
            console.log('PayPal 支付成功:', details);
            container.remove();
            resolve(true);
          });
        },
        ...
        onError: function onError(err) {
          container.remove();
          reject(new Error('PayPal 支付出错: ' + err));
        }
      }).render('#paypal-temp-container');
    }
    ...
    value: function () {
      var _processStripePayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(orderId, paymentParams, itemName) {
        var _this6 = this;
            ...
            case 0:
              return _context8.a(2, new Promise(function (resolve, reject) {
                if (!window.Stripe) {
                  ...
                  script.onload = function () {
                    return _this6.redirectToStripeCheckout(orderId, paymentParams, itemName, resolve, reject);
                  };
                  script.onerror = function () {
                    return reject(new Error('Stripe SDK 加载失败'));
                  };
                  document.head.appendChild(script);
                } else {
                  _this6.redirectToStripeCheckout(orderId, paymentParams, itemName, resolve, reject);
                }
              }));
          }
        }, _callee8);
      }));
      function processStripePayment(_x4, _x5, _x6) {
        return _processStripePayment.apply(this, arguments);
      }
      return processStripePayment;
    }()
  }, {
    key: "redirectToStripeCheckout",
    value: function () {
      var _redirectToStripeCheckout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(orderId, paymentParams, itemName, resolve, reject) {
        var stripe, _yield$stripe$redirec, error;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              stripe = window.Stripe(paymentParams.publishableKey);
              _context9.n = 1;
              return stripe.redirectToCheckout({
                lineItems: [{
                  price_data: {
                    ...
                    unit_amount: paymentParams.amount
                  },
                  quantity: 1
                }],
                mode: 'payment',
                successUrl: "".concat(window.location.origin, "/pages/payment-success.html?orderId=").concat(orderId),
                cancelUrl: "".concat(window.location.origin, "/pages/payment-cancel.html?orderId=").concat(orderId)
              });
            case 1:
              _yield$stripe$redirec = _context9.v;
              error = _yield$stripe$redirec.error;
              if (error) {
                reject(new Error(error.message));
              }
              // Stripe 会跳转，不会执行 resolve
            case 2:
              return _context9.a(2);
          }
        }, _callee9);
      }));
      function redirectToStripeCheckout(_x7, _x8, _x9, _x0, _x1) {
        return _redirectToStripeCheckout.apply(this, arguments);
      }
    ...
    value: function () {
      var _processMockPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(orderId) {
      ...
      function processMockPayment(_x10) {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            case 0:
              ...
              token = _core_auth_js__WEBPACK_IMPORTED_MODULE_3__["default"].getToken();
              i = 0;
            case 1:
              if (!(i < maxAttempts)) {
                _context1.n = 9;
            ...
            case 5:
              if (!(((_data$data = data.data) === null || _data$data === void 0 ? void 0 : _data$data.status) === 'failed')) {
                _context1.n = 6;
                break;
              }
    ...
    value: function resetPaymentForm() {
      ...
      (_document$getElementB5 = document.getElementById('paymentForm')) === null || _document$getElementB5 === void 0 || _document$getElementB5.reset();
    ...
    value: function showLoading() {
      ...
      (_document$getElementB6 = document.getElementById('pageLoading')) === null || _document$getElementB6 === void 0 || _document$getElementB6.classList.add('show');
    }
  }, {
    key: "hideLoading",
    value: function hideLoading() {
      var _document$getElementB7;
      (_document$getElementB7 = document.getElementById('pageLoading')) === null || _document$getElementB7 === void 0 || _document$getElementB7.classList.remove('show');
    }
  }, {
    key: "showToast",
