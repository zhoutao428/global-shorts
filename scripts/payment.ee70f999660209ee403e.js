...
var PaymentPage = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentPage, [{
    ...
    value: function updatePaymentFormFields() {
      ...
      if (method === 'stripe') {
        // Stripe：隐藏卡信息，移除 required
        cardFields.forEach(function (id) {
          _this5.hideFormGroup(id);
          _this5.setRequired(id, false);
        });
        ...
        // PayPal：全部隐藏，全部移除 required
        cardFields.forEach(function (id) {
          _this5.hideFormGroup(id);
          _this5.setRequired(id, false);
        });
        this.hideFormGroup(emailField);
        this.setRequired(emailField, false);
      } else {
        // 信用卡：显示全部，恢复 required
        cardFields.forEach(function (id) {
          _this5.showFormGroup(id);
          _this5.setRequired(id, true);
        });
        this.showFormGroup(emailField);
        this.setRequired(emailField, true);
