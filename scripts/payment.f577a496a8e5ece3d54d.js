  ...
  return _createClass(PaymentPage, [{
    ...
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var _document$getElementB5, _document$getElementB6, _document$getElementB7, _document$getElementB8, _document$getElementB9;
        var formData, payBtn, originalText, response, userRes, _response, _t4;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 5:
              ...
              _context6.n = 6;
              return _core_api_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.rechargeCoin({
            ...
            case 7:
              _context6.n = 8;
              return _core_api_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.upgradeVip({
                planId: this.selectedPackage.id,
                amount: this.selectedPackage.price,
                paymentMethod: this.selectedPaymentMethod
              });
            case 8:
            ...
            case 11:
              ...
              break;
            case 12:
              this.showError(((_response = response) === null || _response === void 0 ? void 0 : _response.error) || '支付失败');
            case 13:
              _context6.n = 15;
              break;
            case 14:
