...
var PaymentPage = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentPage, [{
    ...
    value: function updatePayButtonState() {
      ...
      var price = pkg.price.toFixed(2);
      if (method === 'card') {
        payBtn.innerHTML = "<i class=\"fas fa-lock\"></i> \u652F\u4ED8 $".concat(price);
      } else if (method === 'stripe') {
        payBtn.innerHTML = "<i class=\"fas fa-external-link-alt\"></i> \u524D\u5F80\u652F\u4ED8 $".concat(price);
      } else if (method === 'paypal') {
        payBtn.innerHTML = "<i class=\"fab fa-paypal\"></i> \u524D\u5F80 PayPal \u652F\u4ED8 $".concat(price);
      } else {
        payBtn.innerHTML = "<i class=\"fas fa-lock\"></i> \u652F\u4ED8 $".concat(price);
      }
    }
