...
var PaymentPage = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentPage, [{
    ...
    value: function updatePaymentFormFields() {
      ...
      // 判断该支付方式是否需要显示表单
      // 跳转类支付（Stripe Checkout、PayPal等）不需要表单
      ...
      if (!needsForm && !needsQrCode) {
        ...
        if (payNowBtn) {
          payNowBtn.disabled = false; // 允许直接支付跳转
        }
        return;
      }
    ...
    value: function needsPaymentForm(method) {
      var formBasedMethods = ['card'];
      return formBasedMethods.includes(method);
    }
    ...
    value: function needsQrCode(method) {
      var qrBasedMethods = ['alipay', 'wechat'];
      return qrBasedMethods.includes(method);
    }
    ...
    value: function isRedirectPayment(method) {
      ...
      var redirectMethods = ['paypal', 'googlepay', 'applepay'];
      return redirectMethods.includes(method) || method === 'stripe' && ((_this$gatewayConfigs$ = this.gatewayConfigs[method]) === null || _this$gatewayConfigs$ === void 0 ? void 0 : _this$gatewayConfigs$.redirect_type) === 'checkout';
    }
    ...
    value: function selectPackage(pkg, type) {
      ...
      var method = this.selectedPaymentMethod;
      if (method === 'card') {
        payBtn.innerHTML = "<i class=\"fas fa-lock\"></i> \u652F\u4ED8 $".concat(pkg.price.toFixed(2));
      } else if (this.isRedirectPayment(method)) {
        payBtn.innerHTML = "<i class=\"fas fa-external-link-alt\"></i> \u524D\u5F80\u652F\u4ED8 $".concat(pkg.price.toFixed(2));
      } else if (this.needsQrCode(method)) {
        payBtn.innerHTML = "<i class=\"fas fa-qrcode\"></i> \u751F\u6210\u4E8C\u7EF4\u7801 \u652F\u4ED8 $".concat(pkg.price.toFixed(2));
      }
      payBtn.disabled = false;
      (_document$getElementB5 = document.getElementById('paymentFormSection')) === null || _document$getElementB5 === void 0 || _document$getElementB5.scrollIntoView({
        behavior: 'smooth'
      });
          ...
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 3:
              ...
              if (this.selectedPackage) {
                ...
                this.updatePayButtonText(finalPrice);
              }
              _context6.n = 5;
              break;
            case 4:
    ...
    value: function updatePayButtonText(finalPrice) {
      var payBtn = document.getElementById('payNowBtn');
      if (!payBtn) return;
      var method = this.selectedPaymentMethod;
      var prefix = method === 'card' ? '支付' : this.isRedirectPayment(method) ? '前往支付' : '生成二维码 支付';
      payBtn.innerHTML = "<i class=\"fas fa-".concat(method === 'card' ? 'lock' : this.isRedirectPayment(method) ? 'external-link-alt' : 'qrcode', "\"></i> ").concat(prefix, " $").concat(finalPrice.toFixed(2));
    }
  }, {
    key: "processPayment",
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var method, _document$getElementB6, _document$getElementB7, _document$getElementB8, _document$getElementB9, cardNumber, cardName, expiry, cvv, _document$getElementB0, email, payBtn, originalText, _document$getElementB1, _document$getElementB10, _document$getElementB11, _document$getElementB12, _document$getElementB13, token, orderRes, orderData, _orderData$data, orderId, paymentParams, gateway, itemName, redirectUrl, qrCodeUrl, userRes, _t6;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 2:
              ...
              return _context7.a(2);
            case 3:
              method = this.selectedPaymentMethod; // 根据支付方式验证
              if (!(method === 'card')) {
                _context7.n = 7;
                break;
              }
              cardNumber = (_document$getElementB6 = document.getElementById('cardNumber')) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.value.replace(/\s/g, '');
              cardName = (_document$getElementB7 = document.getElementById('cardName')) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.value;
              expiry = (_document$getElementB8 = document.getElementById('expiry')) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.value;
              cvv = (_document$getElementB9 = document.getElementById('cvv')) === null || _document$getElementB9 === void 0 ? void 0 : _document$getElementB9.value;
            ...
            case 6:
              ...
              return _context7.a(2);
            case 7:
              if (!(method === 'stripe' && this.needsPaymentForm(method))) {
                _context7.n = 8;
                break;
              }
              email = (_document$getElementB0 = document.getElementById('email')) === null || _document$getElementB0 === void 0 ? void 0 : _document$getElementB0.value;
            ...
            case 8:
              ...
              _context7.p = 9;
              token = _core_auth_js__WEBPACK_IMPORTED_MODULE_2__["default"].getToken(); // 创建订单
              _context7.n = 10;
              return fetch('/api/payment/order', {
                ...
                body: JSON.stringify(_objectSpread({
                  ...
                  cardNumber: (_document$getElementB1 = document.getElementById('cardNumber')) === null || _document$getElementB1 === void 0 ? void 0 : _document$getElementB1.value.replace(/\s/g, ''),
                  cardName: (_document$getElementB10 = document.getElementById('cardName')) === null || _document$getElementB10 === void 0 ? void 0 : _document$getElementB10.value,
                  expiry: (_document$getElementB11 = document.getElementById('expiry')) === null || _document$getElementB11 === void 0 ? void 0 : _document$getElementB11.value,
                  cvv: (_document$getElementB12 = document.getElementById('cvv')) === null || _document$getElementB12 === void 0 ? void 0 : _document$getElementB12.value,
                  email: (_document$getElementB13 = document.getElementById('email')) === null || _document$getElementB13 === void 0 ? void 0 : _document$getElementB13.value
                } : {}))
              });
            case 10:
            ...
            case 12:
              _orderData$data = orderData.data, orderId = _orderData$data.orderId, paymentParams = _orderData$data.paymentParams, gateway = _orderData$data.gateway, itemName = _orderData$data.itemName, redirectUrl = _orderData$data.redirectUrl, qrCodeUrl = _orderData$data.qrCodeUrl; // 根据支付方式处理
              if (!(gateway === 'stripe' && paymentParams !== null && paymentParams !== void 0 && paymentParams.url)) {
                _context7.n = 13;
                break;
              }
              // Stripe Checkout 跳转
            ...
            case 14:
              ...
              // 显示二维码
              this.displayQrCode(qrCodeUrl, orderId);
    ...
    value: function startQrCodePolling(orderId) {
      var _this8 = this;
      this.qrCodePollingInterval = setInterval(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var success;
    ...
    value: function () {
      var _checkOrderStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(orderId) {
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            ...
            case 2:
              data = _context9.v;
              return _context9.a(2, data.success && data.data.status === 'success');
            case 3:
              _context9.p = 3;
              _t7 = _context9.v;
    ...
    key: "pollOrderStatus",
    value: function () {
      var _pollOrderStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(orderId) {
        var maxAttempts,
          interval,
          i,
          success,
        ...
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            case 0:
              maxAttempts = _args0.length > 1 && _args0[1] !== undefined ? _args0[1] : 30;
              interval = _args0.length > 2 && _args0[2] !== undefined ? _args0[2] : 2000;
              i = 0;
            case 1:
              if (!(i < maxAttempts)) {
                _context0.n = 5;
    ...
    value: function resetPaymentForm() {
      var _document$getElementB14,
        _this9 = this;
      (_document$getElementB14 = document.getElementById('paymentForm')) === null || _document$getElementB14 === void 0 || _document$getElementB14.reset();
      this.selectedPackage = null;
      this.discount = 0;
      this.promoCode = null;
    ...
    value: function showLoading() {
      ...
      (_document$getElementB15 = document.getElementById('pageLoading')) === null || _document$getElementB15 === void 0 || _document$getElementB15.classList.add('show');
    }
  }, {
    key: "hideLoading",
    value: function hideLoading() {
      var _document$getElementB16;
      (_document$getElementB16 = document.getElementById('pageLoading')) === null || _document$getElementB16 === void 0 || _document$getElementB16.classList.remove('show');
    }
  }, {
    key: "showToast",
