...
var PaymentPage = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentPage, [{
    ...
    // 前端 payment.js 中的 processPayment 方法
  }, {
    key: "processPayment",
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var payBtn, originalText, token, orderRes, orderData, _orderData$data, orderId, paymentParams, gateway, paymentSuccess, userRes, _t5;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 8:
              ...
              break;
            case 9:
              console.error('❌ paymentParams.url 不存在:', paymentParams);
              throw new Error('Stripe 支付链接获取失败，请检查后台配置');
            case 10:
              _context6.n = 21;
              break;
            case 11:
            ...
            case 22:
              _context6.p = 22;
              _t5 = _context6.v;
              console.error('❌ 支付失败:', _t5);
              this.showError(_t5.message || '支付失败，请重试');
              payBtn.innerHTML = originalText;
              payBtn.disabled = false;
            case 23:
              return _context6.a(2);
    ...
    value: function startQrCodePolling(orderId) {
      var _this8 = this;
      this.qrCodePollingInterval = setInterval(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var success;
    ...
    value: function () {
      var _checkOrderStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(orderId) {
        var token, res, data, _t6;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 2:
              data = _context8.v;
              return _context8.a(2, data.success && data.data.status === 'success');
            case 3:
              _context8.p = 3;
              _t6 = _context8.v;
    ...
    key: "pollOrderStatus",
    value: function () {
      var _pollOrderStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(orderId) {
        var maxAttempts,
          interval,
          i,
          success,
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            case 0:
              maxAttempts = _args9.length > 1 && _args9[1] !== undefined ? _args9[1] : 30;
              interval = _args9.length > 2 && _args9[2] !== undefined ? _args9[2] : 2000;
              i = 0;
            case 1:
              if (!(i < maxAttempts)) {
                _context9.n = 5;
    ...
    value: function resetPaymentForm() {
      var _document$getElementB6,
        _this9 = this;
      (_document$getElementB6 = document.getElementById('paymentForm')) === null || _document$getElementB6 === void 0 || _document$getElementB6.reset();
      this.selectedPackage = null;
      this.discount = 0;
      this.promoCode = null;
    ...
    value: function showLoading() {
      ...
      (_document$getElementB7 = document.getElementById('pageLoading')) === null || _document$getElementB7 === void 0 || _document$getElementB7.classList.add('show');
    }
  }, {
    key: "hideLoading",
    value: function hideLoading() {
      var _document$getElementB8;
      (_document$getElementB8 = document.getElementById('pageLoading')) === null || _document$getElementB8 === void 0 || _document$getElementB8.classList.remove('show');
    }
  }, {
    key: "showToast",
