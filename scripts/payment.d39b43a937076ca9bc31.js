  ...
  return _createClass(PaymentPage, [{
    ...
    value: function renderPaymentMethods() {
      ...
      document.querySelectorAll('.method-card').forEach(function (card) {
        card.addEventListener('click', function () {
          ...
          _this3.selectedPaymentMethod = card.dataset.method;
        });
      });
    ...
    value: function () {
      var _processPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var payBtn, originalText, token, orderRes, orderData, _orderData$data, orderId, paymentParams, gateway, itemName, paymentSuccess, userRes, _t6;
              ...
              return _context9.a(2, new Promise(function (resolve, reject) {
                if (!window.Stripe) {
                  ...
                  script.onload = function () {
                    return _this5.redirectToStripeCheckout(orderId, publishableKey, paymentParams, itemName, resolve, reject);
                  };
                  ...
                  _this5.redirectToStripeCheckout(orderId, publishableKey, paymentParams, itemName, resolve, reject);
                }
              }));
          }
        }, _callee9, this);
